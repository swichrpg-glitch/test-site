(() => {
  ...
  // 04. Что получает клиент — benefits section
  ...
  benefits.innerHTML = `
    ...
    <div class="benefits-grid">
      ...
      <div class="benefit-list">
        <article class="benefit-item"><span>01</span><div><h3>Понятная структура</h3><p>Информация выстроена так, чтобы её было легко читать и воспринимать.</p></div><b>↗</b></article>
        <article class="benefit-item"><span>02</span><div><h3>Единая визуальная система</h3><p>Типографика, акценты и композиция работают как одно целое.</p></div><b>↗</b></article>
        <article class="benefit-item"><span>03</span><div><h3>Готовность к работе</h3><p>Финальный материал можно сразу отправлять, показывать, публиковать или использовать в работе.</p></div><b>↗</b></article>
        <article class="benefit-item"><span>04</span><div><h3>Исходник и порядок</h3><p>Файлы собраны аккуратно, чтобы проект можно было продолжить редактировать.</p></div><b>↗</b></article>
      </div>
    </div>`;
  services.parentNode.insertBefore(benefits, services);

  // 06. Character details — visual signature of the site
